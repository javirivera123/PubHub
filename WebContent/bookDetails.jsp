		...
		<form action="UpdateBook" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-5">
		      <input type="number" step="0.01" class="form-control" id="price" name="price" placeholder="Price" required="required" value="${book.price }" />
				...
				<div class="form-group"><!-- list of tags  -->
				<label for="tags" class="col-sm-4 control-label">Tag</label>
					<div class="col-sm-5">
		     		 <input type="text" class="tag" name="tag" required="required" value="${tag}" />
		     		  <button type="button" value="${tag}" id="DeleteTag" >Delete Tag</button>
		   			</div>
		   			</div>
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4 col-sm-1">
		      ...
		      <button type="button"  id="Delete">Delete Option</button>
